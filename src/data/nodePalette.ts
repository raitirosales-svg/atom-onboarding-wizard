...
export const NODE_PALETTE: PaletteNodeInfo[] = [
  ...
  // Integraciones (Visually distinct - dashed border, larger, plug icon)
  {
    ...
    label: 'CRM',
    description: 'Crea o actualiza contactos/tratos en CRM (HubSpot, Salesforce, Zoho).',
    iconName: 'Plug',
    color: '#DC2626', // Red
    isIntegration: true,
  },
  {
    ...
    description: 'Genera links o procesa cobros (MercadoPago, Stripe, Wompi).',
    iconName: 'CreditCard',
    color: '#16A34A', // Green
    isIntegration: true,
  },
  {
    type: 'database_api',
    category: 'Integraciones',
    label: 'Base de datos / API externa',
    description: 'Consulta o envía información vía Webhook REST API o Base de Datos.',
    iconName: 'Server',
    color: '#7C3AED', // Violet
    isIntegration: true,
  },
  {
    type: 'meta_capi',
    category: 'Integraciones',
    label: 'Conversion API (Meta)',
    description: 'Envía eventos de conversión a Meta Pixel para campañas publicitarias.',
    iconName: 'Globe',
